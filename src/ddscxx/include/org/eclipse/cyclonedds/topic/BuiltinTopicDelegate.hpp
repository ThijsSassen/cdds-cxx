...
public:
    ...
    {
        key_.delegate().value((int32_t*)key);
    }
...
public:
    ...
    {
        participant_key_.delegate().value((int32_t*)key);
    }
...
public:
    ...
    {
        publisher_key_.delegate().value((int32_t*)key);
    }
...
public:
    ...
    {
        subscriber_key_.delegate().value((int32_t*)key);
    }
